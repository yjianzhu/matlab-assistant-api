function [response, streamedText] = Assistant_message(api_key, endpoint,message, timeout, streamFun)
    ...
    % Define the request message, body             %   -d '{
            ...
            %       "content": message
            %     }'
    body = matlab.net.http.MessageBody(struct('role','user','content',message));
